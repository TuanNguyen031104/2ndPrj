...
router.post("/get-show-by-id", authMiddleware, async (req, res) => {
    try {
        ...
        // --- ADD DEBUG LOG HERE ---
        console.log("Backend Debug: Fetched show object from DB for ID", req.body.showId);
        console.log("Backend Debug: Booked seats in DB before sending to frontend:", show ? show.bookedSeats : 'Show not found');
        // --- END DEBUG LOG ---
        res.send({
            success: true,
